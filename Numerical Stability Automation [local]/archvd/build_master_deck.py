...
for pch_file in pch_files:
    ...
    # Calculate physical half-height for surface offset
    half_height = target_beam_T / 2.0
    top_offset = -half_height  # Negative offset shifts shell outward (+z direction)
    bot_offset = +half_height  # Positive offset shifts shell outward (-z direction)
